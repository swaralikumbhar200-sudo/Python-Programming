...
#1.Training accuracy
#2.Testing accuracy
#3.Compare both and comment whether the model is overfitting or underfitting.
...
######################################################################
#Step 7 : Compare Training and Testing Accuracy
######################################################################

print(Border)
print("Step 7 : Compare Training and Testing Accuracy")
print(Border)
...
if training_accuracy>testing_Accuracy:
    ...
    print("The model is performing well with no significant overfitting or underfitting.")